...
enum Etype {SPHERE=1, PLANE, CYLINDER, TRIANGLE};
...
Object* initCylinder(vec3 direction, point3 base, float radius, float length, Material mat);
Object* initTriangle(point3 a, point3 b, point3 c);
